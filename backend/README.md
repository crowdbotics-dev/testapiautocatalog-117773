...
## Project Structure
    ...
    ├── testapiautocatalog_117773  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_117773`
...
2. Clone this repo and `cd testapiautocatalog_117773`
